...
- Please be sure that all the steps in [lab 3](https://opencourse.inf.ed.ac.uk/ttds/lab-3) already done, and that you have index you built for the collection (trec) from lab 2 ready.
...
- In case you haven't finished this before, you can find the list of ranked documents for Lab 3 queries in the following [results file](https://opencourse.inf.ed.ac.uk/sites/default/files/https/opencourse.inf.ed.ac.uk/ttds/2023/results.ranked.txt).   
